    ...
    <div className="accordion-grid">
      ...
      <div className="grid-content">
        <h2 style={{ marginBottom: "15px" }}>
          A LEGACY THAT STANDS FOR QUALITY, HONESTY AND INNOVATION.
        </h2>
        <p
        ...
        >
          ...
          cutting edge Construction Materials for architectural spaces that
          aspire to contribute to the creative vision and endeavours of
          Architects, contractors, and designers. Our products include but are
          not limited to RCC Bollards, Wall Tiles, Paving Tiles, Platform
          Copying, Interlock Paving Tile. We transcend our competitors with our
          modern approach, varied range of quality products and textures, ease
          of installation, and most importantly our legacy that puts honesty and
          experience first. We at Dalal Tiles ambitiously open up a world of
          possibilities to realize ideas into reality with our constantly
          developing tools and a culture that thrives on innovation while
          keeping utility and elegance in place.
          <br />
          <br />
          ...
          15658:2006 and IS 1237:1980 for our flooring products. Our spacious
          warehouse facility has requisites for safe storage of products in
          large amount. The entire area is strategically segmented and labeled
          that assists in swift movement of the stored products. Suitable
          temperature and humidity level is maintained to ensure original
          conditions of CC Interlocking Paver, GRC Products, and other products.
        </p>
