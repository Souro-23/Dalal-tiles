  ...
  return (
    <from className="contact-form">
      ...
      <div className="form-group">
        ...
        <div className="grid">
          <div style={!oldUser?{border:"2px solid black"}:{}}  onClick={()=>{setOldUser(false)}} className="block-content">
            <p>Yes</p>
          </div>
          <div style={oldUser?{border:"2px solid black"}:{}}   onClick={()=>{setOldUser(true)}} className="block-content">
            <p>No</p>
          </div>
        </div>
      </div>
      ...
      <div className="form-group">
        ...
        <textarea name="message" rows="5" placeholder="Your Message" onChange={(e)=>{setMessage(e.target.value)}}></textarea>
      </div>
